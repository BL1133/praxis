      ...
      <div className="py-8 mx-auto max-w-6xl lg:py-16">
        <div className="grid gap-4 px-4 mb-4 sm:mb-5 sm:grid-cols-3 sm:gap-6 md:gap-12">
          ...
          <dl>
            ...
            <dd className="flex items-center mb-4 space-x-1 sm:mb-5">
              <button
                type="button"
                data-tooltip-target="tooltip-indesign"
              ...
              <button
                type="button"
                data-tooltip-target="tooltip-sketch"
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  className="w-4 h-4"
              ...
              <button
                type="button"
                data-tooltip-target="tooltip-adobexd"
                className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <svg
                  className="w-4 h-4"
